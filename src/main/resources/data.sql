...
VALUES (1, '2022-04-02', 9500, 'г.Лида, ул. Радунская д.19'),
       (2, '2022-06-10', 1550, 'г.Лида, г.Лида, ул. Машерова 21'),
       (2, '2022-08-01', 40, 'г.Лида, ул. Машерова 21'),
       (3, '2022-10-01', 24, 'г.Лида, ул. Машерова 27');;

INSERT INTO order_details (order_id, product_id, price, quantity, amount)
VALUES (1, 2, 3000, 2, 6000),
       (1, 7, 3500, 1, 3500),
       (2, 6, 150, 1, 150),
       (2, 4, 200, 2, 400),
       (2, 3, 500, 2, 1000),
...
INSERT INTO storage (shop_id, product_id, quantity)
VALUES (1, 1, 100),
       (2, 2, 200),
       (1, 3, 300),
       (3, 4, 400),
